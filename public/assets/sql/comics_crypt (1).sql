...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 11 juin 2026 à 16:52
...
CREATE TABLE `series` (
  ...
  `comicvine_volume_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `series` (`id`, `series_id`, `name`, `sort_name`, `format`, `color`, `dimensions`, `paper_stock`, `binding`, `publishing_format`, `publication_type`, `notes`, `tracking_notes`, `year_began`, `year_ended`, `year_began_uncertain`, `year_ended_uncertain`, `publication_dates`, `first_issue`, `last_issue`, `issue_count`, `country`, `language`, `publisher`, `universe_id`, `logo`, `external_link`, `created_at`, `updated_at`, `publisher_id`, `comicvine_volume_id`) VALUES
